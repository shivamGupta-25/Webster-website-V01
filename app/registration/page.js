...
// RESET NHI HO RAHA DROPDOWN FILED
					...
					<div className="w-full max-w-lg p-8 bg-white shadow-lg rounded-xl space-y-6">
						...
						>
							...
							>
								...
								<SelectContent>
									<SelectItem value="Shivaji College">
										Shivaji College
									</SelectItem>
							...
							>
								...
								<SelectContent>
									<SelectItem value="UI/UX Workshop">
										UI/UX Workshop
									</SelectItem>
									<SelectItem value="Gaming Event">
										Gaming Event
									</SelectItem>
									<SelectItem value="Coding Event">
										Coding Event
									</SelectItem>
								</SelectContent>
							</Select>
