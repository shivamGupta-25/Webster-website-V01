...
const Council = () => {
    return (
        <motion.div
            id="council"
            className="container mx-auto px-4 mt-16 flex flex-col items-center"
        ...
        >
            <motion.div
                ...
                viewport={{ once: false, amount: 0.2 }}
            >
                <h1 className="text-7xl sm:text-4xl md:text-5xl lg:text-8xl font-bold text-gray-900 text-center">Council</h1>
            </motion.div>
            <motion.div
