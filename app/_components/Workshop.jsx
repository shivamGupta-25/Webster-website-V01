            ...
            >
                ...
                <div className="p-6 sm:p-8 lg:p-10 text-center">
                    ...
                    <motion.div 
                        ...
                        whileTap={{ scale: 0.92 }}
                    >
                        <Button className="px-4 py-3 sm:p-6 rounded-[30px] shadow-lg hover:scale-105 transition-all text-base sm:text-lg font-normal tracking-wide">Register</Button>
                    </motion.div>
                </div>
            </motion.div>
        </div>
