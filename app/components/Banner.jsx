		...
		<div className="container px-4 mx-auto">
			...
			>
				...
				>
					...
					<h2 className="text-sm md:text-2xl font-normal">
					...
					<p className="py-6 text-base md:text-lg">
						Webster's established in 1984, the Department of
						Computer Science is dedicated to fostering academic
						excellence and intellectual growth. It strives to
						enhance the cognitive aspect of education, ensuring a
					...
					>
						...
						<Button
							variant="outline"
							className="p-6 md:p-6 rounded-[30px] shadow-lg hover:scale-105 transition-all text-lg md:text-lg font-bold tracking-wide"
						>
							Techelons - 25
						</Button>
					</motion.div>
