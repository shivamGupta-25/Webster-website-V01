...
const Workshop = () => {
	...
	return (
		<div
			id="workshop"
			ref={ref}
			className="container px-6 sm:px-10 lg:px-16 mt-12 flex flex-col items-center"
		>
			<motion.h1
			...
			>
				...
				<div className="p-6 sm:p-8 lg:p-10 text-center">
					...
					>
						Join us for an immersive workshop where you'll gain
						valuable insights and hands-on experience from industry
						experts.
					</motion.p>
					<motion.div
					...
					>
						...
						<p>
							...
							Conference Hall, Delhi University
						</p>
						<p>
							<strong className="text-gray-900 dark:text-white">
								📖 Description:
							</strong>{" "}
							This workshop will cover essential topics in data
							science, machine learning, and modern web
							development with hands-on sessions led by industry
							professionals.
						</p>
					</motion.div>
					<motion.div
						...
						whileTap={{ scale: 0.92 }}
					>
						<Button className="px-4 py-3 sm:p-6 rounded-[30px] shadow-lg hover:scale-105 transition-all text-base sm:text-lg font-normal tracking-wide">
							Register
						</Button>
					</motion.div>
				</div>
